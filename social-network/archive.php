      ...
      <div class="row">
        <div class="col-md-9">
            ...
            <h4 class="archive-title"><?php
                if ( is_day() ) :
                    printf( esc_html__( 'Daily Archives: %s', 'chilepro' ), '<span>' . get_the_date() . '</span>' );
                elseif ( is_month() ) :
                    printf( esc_html__( 'Monthly Archives: %s', 'chilepro' ), '<span>' . get_the_date( esc_html_x( 'F Y', 'monthly archives date format', 'chilepro' ) ) . '</span>' );
                elseif ( is_year() ) :
                    printf( esc_html__( 'Yearly Archives: %s', 'chilepro' ), '<span>' . get_the_date( esc_html_x( 'Y', 'yearly archives date format', 'chilepro' ) ) . '</span>' );
                else :
                    esc_html_e( 'Archives', 'chilepro' );
                endif;
                ?>
            </h4>
