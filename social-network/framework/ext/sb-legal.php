 ...
 * @since 2.8.0
 */
class sb_Legal extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'sb_widget_chilepro_legal', 'description' => esc_html__('Arbitrary text or HTML.','chilepro'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('sb_chilepro_legal', esc_html__('chilepro Legal ','chilepro'), $widget_ops, $control_ops);
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('story')); ?>"><?php esc_html_e('Our Privacy & Policy Link:','chilepro'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('mission')); ?>"><?php esc_html_e('Terms & Conditions Link:','chilepro'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('journal')); ?>"><?php esc_html_e('Secure Payments Link:','chilepro'); ?></label>
...
add_action('widgets_init', 'sb_legal');

function sb_legal(){

    register_widget('sb_Legal');
