...
class hospital_listing extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'sb_widget_recent_entries', 'description' => esc_html__( "Hospital Listing",'chilepro' ) );
        parent::__construct('hospital_latest', esc_html__('Hospital Listing','chilepro' ), $widget_ops);
