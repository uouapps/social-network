...
wp_enqueue_style('iv_directories-style-66', SB_CSS . 'widget.css');

										
		$display_option ='list';// (isset($instance['display_option'])? $instance['display_option']:'list');
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Latest Hospital','chilepro'  );
			 ...
			 <div id="parent-listing" class="margin-top" >
				 <div class="widget_right" >
					 ...
					 <div class="widget_left"  >
						...
						?>
						<img  class="image-80" src="<?php echo  $feature_img;?>" alt="Default image">
						<?php		
						}else{	?>		
																
							<img  class="image-80"  src="<?php echo  wp_iv_directories_URLPATH."/assets/images/default-directory.jpg";?>" alt="Default directory">
