...
class SB_Widget_Tag_Cloud extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 'description' => esc_html__( "A cloud of your most used tags.",'chilepro') );
		parent::__construct('tag_cloud', esc_html__('chilepro Tag Cloud','chilepro'), $widget_ops);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( !empty($instance['title']) ) {
			...
			if ( 'post_tag' == $current_taxonomy ) {
				$title = esc_html__('Tags','chilepro');
			} else {
...
?>
	...
	<p><label for="<?php echo esc_attr($this->get_field_id('taxonomy')); ?>"><?php esc_html_e('Taxonomy:','chilepro') ?></label>
...
add_action('widgets_init', 'sb_tag');
