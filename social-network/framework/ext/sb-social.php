 ...
 * @since 2.8.0
 */
class sb_Social extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'sb_widget_chilepro_social', 'description' => esc_html__('Arbitrary text or HTML.','chilepro'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('sb_chilepro_social', esc_html__('chilepro Social ','chilepro'), $widget_ops, $control_ops);
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('facebook')); ?>"><?php esc_html_e('Facebook Profile Link:','chilepro'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('twitter')); ?>"><?php esc_html_e('Twitter Profile Link:','chilepro'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('linkedin')); ?>"><?php esc_html_e('Linkedin Profile Link:','chilepro'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('googleplus')); ?>"><?php esc_html_e('GooglePlus Profile Link:','chilepro'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php esc_html_e('Pinterest Profile Link:','chilepro'); ?></label>
...
add_action('widgets_init', 'sb_social');

function sb_social(){

    register_widget('sb_Social');
