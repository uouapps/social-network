...
// Hook into the 'init' action
			...
			public function custom_iv_payment_column( $column, $post_id ) {
				...
				public function iv_directories_save_package() {
					...
					$post_content= $form_data['package_feature']; 
						...
						update_post_meta($newpost_id, 'iv_directories_user_type', $form_data['iv_member_type']);
			...
			public function iv_directories_update_paypal_settings() {
				...
				public function iv_directories_create_coupon() {
					...
					global $wpdb;			
						...
						update_post_meta($newpost_id, 'chilepro_coupon_pac_id', $pck_ids);
						update_post_meta($newpost_id, 'chilepro_coupon_limit',$coupon_limit);
						
						update_post_meta($newpost_id, 'chilepro_coupon_start_date', $form_data['start_date']);
						update_post_meta($newpost_id, 'chilepro_coupon_end_date', $form_data['end_date']);
						update_post_meta($newpost_id, 'chilepro_coupon_amount', $form_data['coupon_amount']);
						update_post_meta($newpost_id, 'chilepro_coupon_type', $form_data['coupon_type']);
		...
		public function iv_directories_update_coupon() {
						...
						update_post_meta($newpost_id, 'chilepro_coupon_pac_id', $pck_ids);
						update_post_meta($newpost_id, 'chilepro_coupon_limit', $form_data['coupon_count']);
						update_post_meta($newpost_id, 'chilepro_coupon_start_date', $form_data['start_date']);
						update_post_meta($newpost_id, 'chilepro_coupon_end_date', $form_data['end_date']);
						update_post_meta($newpost_id, 'chilepro_coupon_amount', $form_data['coupon_amount']);
...
public function iv_directories_update_email_setting(){
		...
		update_option( 'chilepro_contact_us_email_subject',$form_data['contactus_email_subject']);
		update_option( 'chilepro_contact_us_email',$form_data['contactus_email_template']);		
		update_option( 'chilepro_contact_us_email_subject_client',$form_data['contactus_client_email_subject']);
		update_option( 'chilepro_contact_us_email_client',$form_data['contactus_client_email_template']);
