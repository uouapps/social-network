...
.html-active .switch-html, .tmce-active .switch-tmce {
	...
	.wp-switch-editor {
		...
		<h3  class=""><?php _e('Directory Setting','chilepro');  ?><small></small>	
		</h3>
		...
		<div id="update_message"> </div>		 
			...
			<form class="form-horizontal" role="form"  name='directory_settings' id='directory_settings'>											
					...
					<label  class="col-md-3 control-label"> <?php _e('Days #','chilepro');  ?></label>
						<div class="col-md-2">						
						...
						<div class="col-md-7">
							...
							<?php _e('The new item badge will show for the days','chilepro');  ?>
						</div>	
					</div>
					-->
					<div class="form-group">
						<label  class="col-md-3 control-label"> <?php _e('Listing Page toggle button[Search + Map] ','chilepro');  ?></label>
					
					<div class="col-md-2">
							<label>												
							<input type="radio" name="search_button_show" id="search_button_show" value='yes' <?php echo ($dir_map_show=='yes' ? 'checked':'' ); ?> ><?php _e('Show','chilepro');  ?>
							</label>	
						</div>
						<div class="col-md-3">	
							<label>											
							<input type="radio"  name="search_button_show" id="search_button_show" value='no' <?php echo ($dir_map_show=='no' ? 'checked':'' );  ?> > <?php _e('Hide','chilepro');  ?>
							</label>
						</div>	
					</div>
					<div class="form-group">
						<label  class="col-md-3 control-label"> <?php _e('Listing Page Top Map','chilepro');  ?></label>
					
					<div class="col-md-2">
							<label>												
							<input type="radio" name="dir_map_show" id="dir_map_show" value='yes' <?php echo ($dir_map_show=='yes' ? 'checked':'' ); ?> ><?php _e('Show  Top Map','chilepro');  ?>
							</label>	
						</div>
						<div class="col-md-3">	
							<label>											
							<input type="radio"  name="dir_map_show" id="dir_map_show" value='no' <?php echo ($dir_map_show=='no' ? 'checked':'' );  ?> > <?php _e('Hide Top Map','chilepro');  ?>
							</label>
						</div>	
					</div>
					...
					<div class="form-group">
						<label  class="col-md-3 control-label"> <?php _e('Listing Page Search Bar','chilepro');  ?></label>
					
					<div class="col-md-2">
							<label>												
							<input type="radio" name="dir_searchbar_show" id="dir_searchbar_show" value='yes' <?php echo ($dir_searchbar_show=='yes' ? 'checked':'' ); ?> ><?php _e('Show  Search Bar','chilepro');  ?>
							</label>	
						</div>
						<div class="col-md-3">	
							<label>											
							<input type="radio"  name="dir_searchbar_show" id="dir_searchbar_show" value='no' <?php echo ($dir_searchbar_show=='no' ? 'checked':'' );  ?> > <?php _e('Hide Search Bar','chilepro');  ?>
							</label>
						</div>	
					</div>
					...
					<div class="form-group">
						<label  class="col-md-3 control-label"> <?php _e('Claim','chilepro');  ?></label>
					
					<div class="col-md-2">
							<label>												
							<input type="radio" name="dir_claim_show" id="dir_claim_show" value='yes' <?php echo ($dir_claim_show=='yes' ? 'checked':'' ); ?> ><?php _e('Show Claim','chilepro');  ?>
							</label>	
						</div>
						<div class="col-md-3">	
							<label>											
							<input type="radio"  name="dir_claim_show" id="dir_claim_show" value='no' <?php echo ($dir_claim_show=='no' ? 'checked':'' );  ?> > <?php _e('Hide Claim','chilepro');  ?>
							</label>
						</div>	
					</div>
					...
					?>
					<div class="form-group">
					<label  class="col-md-3 control-label"> <?php _e('Listing Radius','chilepro');  ?></label>
				...
				<div class="form-group">
					<label  class="col-md-3 control-label"> <?php _e('Cron Job URL','chilepro');  ?>						 
