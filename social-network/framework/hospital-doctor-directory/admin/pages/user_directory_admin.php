	...
	<div class="welcome-panel container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-header" ><?php  _e('User Setting','chilepro')	;?>  <small>  </small> </h3>
        	 		 ...
        	 		 <form class=" dd col-md-6"   action="<?php echo the_permalink(); ?>" method="post"  >     
						...
						?>	
						 <table class="table">						 
						  <thead>
							<tr>	
							  <th> <?php  _e('Create Date','chilepro')	;?> </th>						 
							  <th> <?php  _e('User Name','chilepro')	;?></th>
							  <th> <?php  _e('Email','chilepro')	;?> </th>
							  <th> <?php  _e('Expiry Date','chilepro')	;?> </th>
							  <th> <?php  _e('Payment Status','chilepro')	;?> </th>							  
							  <th> <?php  _e('Role','chilepro')	;?> </th>
							  <th> <?php  _e('Balance','chilepro')	;?> </th>
				        	...
				        	foreach ( $user_query->results as $user ) {								
								...
								?>
									<tr>
									  ...
									  <td>		<a class="btn btn-primary btn-xs" href="?page=wp-iv_directories-user_update&id=<?php echo $user->ID; ?>"> <?php  _e('Edit','chilepro')	;?></a> 
												<a class="btn btn-danger btn-xs" href="<?php echo admin_url().'/users.php'?>"><?php  _e('Delete','chilepro')	;?> </a>
									  </td>
									</tr>
