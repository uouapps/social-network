		...
		jQuery(document).ready(function(){
			jQuery("#submit_iv_directories").on("click",function(){
						...
						if(valid == 1){
							...
							jQuery('#loading').html("<img src='<?php echo wp_iv_directories_URLPATH. 'admin/files/images/loader.gif'; ?>' />");
	...
	function save_the_form() {
		...
		var iv_client_email =		jQuery("#client-email").val(); 
				// New Block For Ajax*****
				var search_params={
					"action"  : 				"iv_directories_save_form",	
				...
				jQuery.ajax({					
					...
					success : function(response){
						...
						var url = "<?php echo wp_iv_directories_ADMINPATH; ?>admin.php?page=wp-iv_directories-from-all&form_submit=success";    						
				...
				<div class="welcome-panel container-fluid">
					...
					<div class="row">
														...
														<label for="text" class="col-md-4 control-label">Form Width</label>
															...
															<div class="col-md-8">
																<div class=" ctrl-radiogroup">
																	<label class="radio"><input type="radio" name="iv_directories_width" value="Responsive" id="Responsive" checked />Responsive</label>
																	<label class="radio"><input type="radio" name="iv_directories_width"  id ="fixed_width" value="custom_width" /> Fixed Width
																	<input type="text"  id="iv_directories_width-input" name="iv_directories_width-input" class="form-control"  value="" placeholder="Enter Form Width  Like 500px" style="display: none" >	</label>
						...
						<div class="row">
							<div class="col-md-5">
								...
								<div class="col-md-8">
									<?php
									$iv_directories_admin_email_subject = get_bloginfo().': Contact Us';
									?>
							...
							<div class="col-md-6">
								...
								<div class="col-md-8">
									<?php
									$iv_directories_auto_email_subject = get_bloginfo().': Contact Us';
									?>
					...
					<div class="row">
						<div class="col-md-5">
							...
							<a data-toggle="modal" href="<?php echo wp_iv_directories_URLPATH; ?>admin/pages/template_email_modal.php?upath=<?php echo wp_iv_directories_URLPATH; ?>" data-target="#modal_template_help"><img  title="Template Preview" class=" right top"  height="30px" src="<?php echo wp_iv_directories_URLPATH; ?>admin/files/images/eye-open-128.png"></a></small></h3> 
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="email-wrap" id="admin-template">
								...
								$content_admin = get_option('iv_directories_admin_email_green');
						...
						<div class="col-md-6 ">
							...
							<div class="col-md-12 email-wrap" id="client-template">
								...
								$content_client = get_option('iv_directories_client_email_green');
