...
<br/>
	...
	<form class="form-horizontal" role="form"  name='map_marker' id='map_marker'>
		 <h3  class="panel-heading"><?php _e('Hospital Category Image / Map Marker','chilepro'); ?></h3> 
		<div class="row ">
			<div class="col-md-12 ">				 	
			<table class="table table-bordered table-hover table-responsive">												  
			  <thead>
				<tr>
				  <th><?php _e('Category Main','chilepro'); ?>  </th>
				  <th><?php _e('Sub Category','chilepro'); ?>  </th>
				  <th><?php _e('Map Marker','chilepro'); ?> </th>
				   <th><?php _e('Category Image','chilepro'); ?> </th>
				</tr>
			  </thead>
			  <tbody>
		...
		<h3  class=""><?php _e('Doctor Category Image / Map Marker','chilepro'); ?> </h3> 	
		<div class="row ">
			<div class="col-md-12 ">
