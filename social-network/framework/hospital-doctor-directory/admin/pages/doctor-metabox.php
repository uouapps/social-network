 <div class="bootstrap-wrapper">
 	<div class="welcome-panel container-fluid">
		...
		//*************************	plugin file *********
 		 ...
 		 $iv_doctor_approve= get_post_meta( $post->ID,'iv_doctor_approve', true );
 		...
 		<div class="row">
 			...
 			<div class="col-md-12"> <label>
 				<input type="checkbox" name="iv_doctor_approve" id="iv_doctor_approve" value="yes" <?php echo ($iv_doctor_approve=="yes" ? 'checked': "" )  ; ?> />  <strong><?php _e( 'Approve', 'iv_directories' )?></strong>
				</label>
 			</div> 
