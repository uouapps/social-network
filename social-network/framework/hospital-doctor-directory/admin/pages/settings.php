								...
								<div class="tab-pane fade " id="dir-setting">								
									...
									<form class="form-horizontal" role="form"  name='tax_settings' id='tax_settings'>										
											 ...
											 <div class="form-group">
												<h3  class="col-md-12   page-header"><?php _e('Tax Setting','chilepro'); ?> </h3>												
											</div>
											...
											?>
											 <div class="row">
												<label  class="col-md-2  pull-left"> <?php _e('Tax Module ','chilepro'); ?>:</label>
												<div class="col-md-3">
													<label>												
													<input type="radio" name="active_tax" id="active_tax" value='yes' <?php echo $active_check_y; ?> > 
													<?php _e('Active Tax On Registration','chilepro'); ?> 
													</label>	
												</div>
												<div class="col-md-3">	
													<label>											
													<input type="radio"  name="active_tax" id="active_tax" value='no' <?php echo $active_check_n; ?> > <?php _e('No Tax','chilepro'); ?>
													</label>
												</div>	
												<div class="col-md-3">
												
													<button type="button" onclick="return  iv_update_tax_settings();" class="btn btn-success"><?php _e('Update','chilepro'); ?></button>
												</div>											
											 </div>
											 <div class="row">
												<label  class="col-md-2  pull-left"> <?php _e('Tax Type ','chilepro'); ?>:</label>
												<div class="col-md-3">
													<label>												
													...
													<?php _e('Common Tax','chilepro'); ?> 
													</label>	
												</div>
												<div class="col-md-3">	
													<label>											
													<input type="radio"  name="tax_type" id="tax_type" value='country' onclick="return iv_show_country_tax();" <?php echo ($tax_type=='country'? 'checked':''); ?> > <?php _e('Tax By Country','chilepro'); ?>
													</label>
												</div>	
											...
											<div class="row " id="common_tax" style="<?php echo ($tax_type=='common'? '':'display: none;'); ?>">	
												...
												<label  class="col-md-2  pull-left"> <?php _e('Common Tax % ','chilepro'); ?>:</label>
												<div class="col-md-3">																							
												...
												<table class="table table-bordered table-responsive table-hover ">												  
												  <thead>
													<tr>
													  ...
													  <th style="text-align: center;"><?php _e('Country','chilepro'); ?> </th>
													 <th style="text-align: center;"><?php _e('Tax %','chilepro'); ?> </th>
													</tr>
												  </thead>
												   <tfoot>
													<tr>
											...
											<div class=" col-md-12  bs-callout bs-callout-info">						
												<?php
															_e('Note : Tax will not work on Stripe Ruccring Subscriotion Payment','chilepro');
													?>
											</div>
											<div class="form-group">
									...
									<form class="form-horizontal" role="form"  name='protected_settings' id='protected_settings'>										
											 ...
											 <div class="form-group">
												<h3  class="col-md-12   page-header"><?php _e('Visibility Control','chilepro'); ?> </h3>												
											</div>
											...
											?>
											 <div class="row">
												<label  class="col-md-3  pull-left"> <?php _e('Content Visibility Module ','chilepro'); ?>:</label>
												<div class="col-md-3">
													<label>												
												...
												<div class="col-md-3">	
													<label>											
													<input type="radio"  name="active_visibility" id="active_visibility" value='no' <?php echo $active_check_n; ?> > <?php _e('Show All','chilepro'); ?>
													</label>
												</div>												
											 </div>
											 ...
											 <div class="form-group">
												<h3  class="col-md-12   page-header"><?php _e('Content Show By Roles','chilepro'); ?></h3>												
											</div>
											
											<div class=" col-md-12  bs-callout bs-callout-info">							
												<?php _e('Select which contents are available for each user role.	','chilepro'); ?>										
											</div>
											...
											<div class="row ">
												...
												<table class="table table-bordered table-responsive table-hover ">												  
												  <thead>
												   ...
												   <tfoot>
													<tr>
													  <th><?php _e('Check/Uncheck','chilepro'); ?></th>
													  <?php
													  global $wp_roles;
													  //$roles = $wp_roles->get_names();
													  //foreach($roles as $role) {
