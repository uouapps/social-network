          ...
          <div class="profile-content">
              ...
              <div class="portlet light">
                  <div class="portlet-title tabbable-line clearfix">
                    <div class="caption caption-md">
                      <span class="caption-subject"><?php  _e('Membership Level','chilepro')	;?>	 </span>
                    </div>
					 <ul class="nav nav-tabs">
                      <li class="active">
                        <a href="#tab_current" data-toggle="tab"><?php  _e('Current','chilepro')	;?></a>
                      </li>
					  <li class="">
                        <a href="#tab_upgrade" data-toggle="tab"><?php  _e('Upgrade','chilepro')	;?></a>
                      </li>
					    
                      <li>
                        <a href="#tab_cancel" data-toggle="tab"><?php  _e('Cancel','chilepro')	;?></a>
                      </li>
						  ...
						  <div class="table-responsive">
							...
							<tr>
									<td  style="font-size:14px;width:40%"> 
										<?php  _e('Current Package','chilepro')	;?>
									</td>
							...
							<tr>
									<td width="40%" style="font-size:14px"> 
										<?php  _e('Package Amount','chilepro')	;?>
									</td>
							...
							<tr>
									<td width="40%" style="font-size:14px"> 
										<?php  _e('Payment Status','chilepro')	;?>
									</td>
									<td width="60%" style="font-size:14px"> 
									<?php 
							...
							<tr>
							 ...
							 ?>
								...
								<tr>
									<td width="40%" style="font-size:14px"> 
										<?php  _e('Next Payment Date','chilepro')	;?>
									</td>
									<td width="60%" style="font-size:14px"> 
									<?php
										if($recurring == 'on'){
			...
			<form class="form-group"  name="profile_upgrade_form" id="profile_upgrade_form" action="<?php  the_permalink() ?>?&payment_gateway=paypal&iv-submit-upgrade=upgrade" method="post">
				...
				<div class=" row form-group">
					<label for="text" class="col-md-4 col-xs-4 col-sm-4 control-label"><?php  _e('Package Name','chilepro')	;?></label>
				...
				<div class="row form-group">
						<label for="text" class="col-md-4 col-xs-4 col-sm-4 control-label"><?php  _e('Amount','chilepro')	;?></label>
					...
					<?php
							...
							?>
							<div class="row form-group">
								<label for="text" class="col-md-4 control-label"><?php  esc_html_e('Vat/Tax','chilepro');?></label>												
							...
							?>					
						<div class="row form-group">
								<label for="text" class="col-md-4 control-label"><?php  esc_html_e('Total','chilepro');?></label>		
								...
								<div class="row form-group">
									...
									<div class="col-md-8 col-xs-8 col-sm-8 " > 	<div id="loading"> </div> 
										...
										<button class="btn green-haze" type="submit"> <?php  esc_html_e('Upgrade','chilepro')	;?></button>
						...
						<?php  esc_html_e('Note: Your Successful Upgrade or Downgrade will affect on your user role immediately.','chilepro')	;?>						
									...
									if($payment_gateway=='paypal-express'){	
										...
										$profile_id = get_user_meta($current_user->ID,'iv_paypal_recurring_profile_id',true);
											if($arb_status!='cancel'  && $profile_id!='' ){											?>
													...
													<div id="paypal_cancel_div" name="paypal_cancel_div">
															<form class="form" role="form"  name="paypal_cancel_form" id="paypal_cancel_form" action="" method="post">
																...
																<label class="control-label"><?php  esc_html_e('Cancel Reason','chilepro')	;?></label>
																<textarea class="form-control" name="cancel_text" id="cancel_text" rows="3" placeholder="<?php  esc_html_e('Canceling Reason','chilepro')	;?>"  ></textarea>
															  </div>
																
																<div class="margiv-top-10">
																	<div class="" id="update_message"></div>
																	
																	<button type="button"   class="btn green-haze" onclick="return iv_cancel_membership_paypal();"><?php  esc_html_e('Cancel Membership','chilepro')	;?></button>
											...
											<?php
												...
												<div class="form-group">
															<label class="control-label"><?php  esc_html_e('Nothing to Cancel','chilepro')	;?></label>
														...
														<div id="stripe_cancel_div" name="stripe_cancel_div">
																...
																<input type="hidden" name="sub_id" value="<?php echo $sub_id; ?>">																	
																	...
																	<div class="margiv-top-10">
																		...
																		<button type="button"   class="btn green-haze" onclick="return iv_cancel_membership_stripe();"><?php  esc_html_e('Cancel Membership','chilepro')	;?></button>
																   </div>
