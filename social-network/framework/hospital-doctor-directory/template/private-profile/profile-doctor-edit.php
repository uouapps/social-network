              ...
              <div class="portlet light">
                <div class="portlet-title tabbable-line clearfix">
                    <div class="caption caption-md">
                      <span class="caption-subject"> <?php esc_html_e('Edit Doctor','chilepro'); ?></span>
                    </div>
						...
						<div class="row">
							...
							<form action="" id="edit_post" name="edit_post"  method="POST" role="form">
								...
								<label for="text" class=" control-label"><?php esc_html_e('Full Name','chilepro'); ?></label>
									<div class="  "> 
										<input type="text" class="" name="title" id="title"  placeholder="<?php esc_html_e('Enter Full Name Here','chilepro'); ?>" value="<?php echo $title;?>">
									</div>																		
								</div>
								...
								<?php
										...
										$currentCategory=wp_get_object_terms( $post_edit->ID, 'doctor-category');
										$selected='';
								...
								<div class="panel-heading">
								  <h4 class="panel-title col-lg-10">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapsenine">
									  <?php esc_html_e('Booking','chilepro'); ?>
									</a>
								  </h4>
									<h4 class="panel-title" style="text-align:right;color:#1AA2E1;font-size:12px;">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapsenine">
								  ...
								  <div class="panel-body">	
									  <?php
										...
										?>	
										  ...
										  <div class="form-group">
												<label class="control-label"><?php esc_html_e('Or, Booking Shortcode','chilepro'); ?>  </label>
										  ...
										  <?php
												...
												_e('Please upgrade your account to add booking detail ','chilepro');
										}
										?>
								  </div>
								</div>
