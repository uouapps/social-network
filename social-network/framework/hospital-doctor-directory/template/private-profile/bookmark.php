...
?>
 <div class="network">
            <h4><?php esc_html_e('Bookmarks','medico'); ?> </h4>
            
            <!-- Nav Tabs -->
            <ul class="nav nav-tabs">
              <li <?php echo ($network_tab =='mybookmark'?'class="active"':'' ); ?> ><a data-toggle="tab" href="#mybookmark"><?php esc_html_e('My bookmarks','medico'); 
                $socialnetwork_value='';
				...
				echo ' ('.sizeof($socialnetwork_value_arr).')';
              	?> </a></li>
              <li <?php echo ($network_tab=='bookmarker'?'class="active"':'' ); ?> ><a data-toggle="tab" href="#bookmarker"><?php esc_html_e('Bookmarkers','medico'); ?> 
              <?php
               $socialnetwork_value='';
            ...
            <div class="tab-content"> 
				...
				<?php
                  ...
                  <div class="filter-flower">
                    <div class="row">
                      <div class="col-sm-7">
                        <ul>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=mybookmark&type=All" <?php echo($connection_type=='All' ?'class="active"':'' ); ?> ><?php esc_html_e('Show All','medico'); ?></a></li>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=mybookmark&type=Professionals" <?php echo($connection_type=='Professionals' ?'class="active"':'' ); ?> ><i class="fa fa-user"></i> <?php esc_html_e('Professionals','medico'); ?></a></li>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=mybookmark&type=Companies" <?php echo($connection_type=='Companies' ?'class="active"':'' ); ?> ><i class="fa fa-building-o"></i> <?php esc_html_e('Companies','medico'); ?></a></li>
                        </ul>
                      </div>
              ...
              <div id="bookmarker" class="tab-pane fade  <?php echo ($network_tab =='bookmarker'?'in active':'' ); ?> ">
				  <?php
				  include(  wp_iv_directories_template. 'private-profile/bookmarker.php');
				  ?>
