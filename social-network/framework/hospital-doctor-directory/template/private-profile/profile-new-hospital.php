              ...
              <div class="portlet light">
                <div class="portlet-title tabbable-line clearfix">
                    <div class="caption caption-md">
                      <span class="caption-subject"> <?php esc_html_e('New Hospital','chilepro'); ?></span>
                    </div>
						...
						<div class="row">
							...
							<form action="" id="new_post" name="new_post"  method="POST" role="form">
								<div class=" form-group">
									...
									<div class="  "> 
										<input type="text" class="" name="title" id="title" value="" placeholder="<?php esc_html_e('Enter Hospital Name Here','chilepro'); ?>">
									</div>																		
								</div>
								...
								<div class=" row form-group ">
									<label for="text" class=" col-md-5 control-label"><?php esc_html_e('Image Gallery','chilepro'); ?> 
										<button type="button" onclick="edit_gallery_image('gallery_image_div');"  class="btn btn-xs green-haze"><?php esc_html_e('Add Images','chilepro'); ?></button>
									 </label>						
								</div>
								<div class=" row form-group ">	
											<!--
								  ...
								  <div class="panel-body">	
									...
									<div class=" row  form-group ">
										...
										<?php
												...
												esc_html_e('Please upgrade your account to add Award ','chilepro');
										}
										?>
									  ...
									  <?php
										 ...
										 if($this->check_write_access('doctor')){
												...
												if(sizeof($total_post)>0){
													...
													?>										
													<div class=" form-group">												
														<label for="text" class=" control-label"><?php esc_html_e('Our Physician','chilepro'); ?></label>
								  ...
								  <div class="panel-body">	
									  <?php
										...
										<?php
												...
												esc_html_e('Please upgrade your account to add video ','chilepro');
										}
										?>
								  ...
								  <div class="panel-body">											
										...
										<div class=" form-group">
											<label for="text" class=" control-label"><?php esc_html_e('Event Title','chilepro'); ?></label>
												<input type="text" class="" name="event-title" id="event-title" value="" placeholder="<?php esc_html_e('Enter Title Here','chilepro'); ?>">							
										</div>	
										<div class=" form-group">
										...
										<?php
												...
												esc_html_e('Please upgrade your account to add event ','chilepro');
										}
										?>
								  </div>
