				...
				<?php
                  ...
                  <div class="filter-flower">
                    <div class="row">
                      <div class="col-sm-7">
                        <ul>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=bookmarker&follower-type=All" <?php echo($connection_type_follower=='All' ?'class="active"':'' ); ?> ><?php esc_html_e('Show All','medico'); ?></a></li>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=bookmarker&follower-type=Professionals" <?php echo($connection_type_follower=='Professionals' ?'class="active"':'' ); ?> ><i class="fa fa-user"></i> <?php esc_html_e('Professionals','medico'); ?></a></li>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=bookmarker&follower-type=Companies" <?php echo($connection_type_follower=='Companies' ?'class="active"':'' ); ?> ><i class="fa fa-building-o"></i> <?php esc_html_e('Companies','medico'); ?></a></li>
                        </ul>
                      </div>
