...
global $wpdb;	
	...
	// Email for Client	**************
	$email_body = get_option( 'chilepro_contact_us_email_client');
	$contact_email_subject = get_option( 'chilepro_contact_us_email_subject_client');			
	...
	$email_body = get_option( 'chilepro_contact_us_email');
	$contact_email_subject = get_option( 'chilepro_contact_us_email_subject');			
