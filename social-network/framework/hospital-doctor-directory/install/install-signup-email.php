...
update_option('chilepro_contact_us_email', trim($contact_us_email_template) ); 
$contact_us_email_subject = 'Contact Us Message '.get_bloginfo();
update_option('chilepro_contact_us_email_subject', $contact_us_email_subject); 
...
update_option('chilepro_contact_us_email_client', trim($contact_us_email_template)  ); 
$contact_us_email_subject = 'Thank You '.get_bloginfo();
update_option('chilepro_contact_us_email_subject_client', $contact_us_email_subject  );
