<?php
/**
 * Chameleon: Breadcrumbs Functions
 *
 * @author      UouApps
 * @category    Core
 * @package     chilepro/admin
 * @version     1.0.0
 */
  ...
  /* === OPTIONS === */
    ...
    if (is_home() || is_front_page()) {
        ...
        if ( is_category() ) {
            ...
            if ( get_post_type() != 'post' ) {
                ...
                if(get_post_type() == 'constraction_projet'){
                    ...
                    if(isset($chameleon_option_data['chameleon-select-search-page']) && !empty($chameleon_option_data['chameleon-select-search-page'])){

                        $search_page_id = $chameleon_option_data['chameleon-select-search-page'];   
        ...
        if ( get_query_var('paged') ) {
            ...
            echo __('Page','chameleon') . ' ' . get_query_var('paged');
            if ( is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author() ) echo ')';
        }
