...
add_action( 'after_setup_theme', 'chameleon_setup' );
...
function uou_theme_features()  {
  ...
  load_theme_textdomain( 'chilepro', get_template_directory() . '/language' );
...
function new_excerpt_more( $more ) {
	return ' <a class="read-more" href="'. get_permalink( get_the_ID() ) . '">' . esc_html__('Read More', 'chilepro') . '</a>';
}
...
/* -------------------------------------------------------------------------
    START chameleon COMMENT WALKER CLASS
------------------------------------------------------------------------- */

class chameleon_comment_walker extends Walker_Comment{
            ...
            <?php echo get_avatar( $comment, $size = '100'); ?>
              <div>
                    ...
                    <?php if($comment->comment_approved == 0): ?>
                        <p> <i class="ico fa fa-exclamation-circle"></i> <?php esc_html_e('Your comment is awaiting to approve','chilepro' ); ?> </p>
                    <?php endif; ?>
...
/* -------------------------------------------------------------------------
    END chameleon COMMENT WALKER CLASS
------------------------------------------------------------------------- */



/* -------------------------------------------------------------------------
    START CUSTOM COMMENT FORM FOR chameleon
------------------------------------------------------------------------- */

function chameleon_custom_comment_form($defaults){
    
    $defaults['comment_notes_before'] = '';
    $defaults['id_form'] = "comment-form";
    $defaults['title_reply'] = _e('<h4>Join Conversation</h4>','chilepro');
...
add_filter('comment_form_defaults', 'chameleon_custom_comment_form');

/* -------------------------------------------------------------------------
    END CUSTOM COMMENT FORM FOR chameleon
------------------------------------------------------------------------- */



/* -------------------------------------------------------------------------
    START CUSTOM COMMENT FORM FIELD FOR chameleon
------------------------------------------------------------------------- */

function chameleon_custom_comment_form_fields(){
...
add_filter('comment_form_default_fields','chameleon_custom_comment_form_fields');

/* -------------------------------------------------------------------------
    END CUSTOM COMMENT FORM FIELD FOR chameleon
------------------------------------------------------------------------- */
