...
function save_connect(id) {       
		  ...
		  var isLogged = tiger_data.current_user_id;
                ...
                if (isLogged=="0") {                   
                     alert(tiger_data.login_connect);
                } else { 
						...
						jQuery.ajax({					
							...
							data : search_params,
							success : function(response){ 
								jQuery("#uouconnect").html('<a href="javascript:;" class="blue-background" onclick="save_deleteconnect('+id+');" ><i class="fa fa-user-plus" ></i> '+tiger_data.Connected+'</a>');
                ...
                if (isLogged=="0") {                   
                     alert(tiger_data.login_connect);
						...
						jQuery.ajax({					
							...
							data : search_params,
							success : function(response){ 
								jQuery("#uouconnect").html('<a   href="javascript:;"  onclick="save_connect('+id+')" ><i class="fa fa-user-plus" ></i> '+tiger_data.Connect+'</a>');
    ...
    function save_bookmark(id) {       
		var background="blue-background" ;
		  ...
		  var isLogged = tiger_data.current_user_id;
                ...
                if (isLogged=="0") {                   
                     alert(tiger_data.login_bookmark);
                } else { 
