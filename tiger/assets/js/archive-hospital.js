	function initialize() {
					var center = new google.maps.LatLng(tiger_data.ins_lat ,tiger_data.ins_lng);
...
function save_favorite(id) {       
		  ...
		  var isLogged = tiger_data.current_user_id;
                ...
                if (isLogged=="0") {                   
                     alert(tiger_data.login_favorite);
                } else { 
						...
						jQuery.ajax({					
							...
							data : search_params,
							success : function(response){ 
								jQuery("#fav_dir"+id).html('<a data-toggle="tooltip" data-placement="bottom" title="'+tiger_data.Add_to_Favorites+'" href="javascript:;" onclick="save_unfavorite('+id+')" ><span class="hide-sm"><i class="fa fa-heart  red-heart fa-lg"></i>&nbsp;&nbsp; </span></a>');
	...
	function save_unfavorite(id) {
		  var isLogged = tiger_data.current_user_id;
                ...
                if (isLogged=="0") {                   
                     alert(tiger_data.login_message);
                } else { 
						...
						jQuery.ajax({					
							...
							data : search_params,
							success : function(response){ 
								jQuery("#fav_dir"+id).html('<a data-toggle="tooltip" data-placement="bottom" title="'+tiger_data.Add_to_Favorites+'" href="javascript:;" onclick="save_favorite('+id+')" ><span class="hide-sm"><i class="fa fa-heart fa-lg "></i>&nbsp;&nbsp; </span></a>');
