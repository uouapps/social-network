      ...
      <div class="row">
        <div class="col-md-9">
            ...
            <h4 class="archive-title"><?php
                if ( is_day() ) :
                    printf( esc_html__( 'Daily Archives: %s', 'tiger' ), '<span>' . get_the_date() . '</span>' );
                elseif ( is_month() ) :
                    printf( esc_html__( 'Monthly Archives: %s', 'tiger' ), '<span>' . get_the_date( esc_html_x( 'F Y', 'monthly archives date format', 'tiger' ) ) . '</span>' );
                elseif ( is_year() ) :
                    printf( esc_html__( 'Yearly Archives: %s', 'tiger' ), '<span>' . get_the_date( esc_html_x( 'Y', 'yearly archives date format', 'tiger' ) ) . '</span>' );
                else :
                    esc_html_e( 'Jobs Archives', 'tiger' );
                endif;
                ?>
            </h4>
