    ...
    if ( ! class_exists( 'ReduxFrameworkPlugin' ) ) {
        ...
        class ReduxFrameworkPlugin {
            ...
            public function includes() {
                // Include ReduxCore
                if ( file_exists(  get_template_directory() . '/framework/redux/ReduxCore/framework.php' ) ) {
                ...
                if ( file_exists(  get_template_directory() . '/framework/redux/ReduxCore/redux-extensions/config.php' ) ) {
                    require_once(  get_template_directory() . '/framework/redux/ReduxCore/redux-extensions/config.php' );
                }

                // Include demo config, if demo mode is active
                if ( $this->options['demo'] && file_exists( get_template_directory() . '/framework/redux/sample/sample-config.php' ) ) {
                    require_once( get_template_directory() . '/framework/redux/sample/sample-config.php' );
                }
            }
                ...
                if ( strpos( $file, 'redux-framework.php' ) !== false && is_plugin_active( $file ) ) {
                    ...
                    if ( ( is_multisite() && $this->plugin_network_activated ) || ! is_network_admin() || ! is_multisite() ) {
                        if ( $this->options['demo'] ) {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . esc_html__( 'Deactivate Demo Mode', 'redux-framework' ) . '</a></span>';
                        } else {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . esc_html__( 'Activate Demo Mode', 'redux-framework' ) . '</a></span>';
                        }
                    }
