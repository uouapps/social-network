        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->_extension_dir ) ) { 
                    $this->_extension_dir = get_template_directory() . '/framework/redux/ReduxCore/inc/extensions/customizer/';
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    include_once (get_template_directory() . '/framework/redux/ReduxCore/inc/extensions/customizer/inc/customizer_section.php');
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    include_once (get_template_directory() . '/framework/redux/ReduxCore/inc/extensions/customizer/inc/customizer_panel.php');
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    include_once (get_template_directory() . '/framework/redux/ReduxCore/inc/extensions/customizer/inc/customizer_control.php');
                }

                include_once (get_template_directory() . '/framework/redux/ReduxCore/inc/extensions/customizer/inc/customizer_fields.php');
                include_once (get_template_directory() . '/framework/redux/ReduxCore/inc/extensions/customizer/inc/customizer_devs.php');
