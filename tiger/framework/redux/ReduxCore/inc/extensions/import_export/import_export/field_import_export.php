            ...
            public function render() {
                ...
                ?>
                    <p>
                        ...
                        <a href="<?php echo esc_attr($link); ?>" id="redux-export-code-dl" class="button-primary"><?php esc_html_e( 'Download Data File', 'redux-framework' ) ?></a>
                    ...
                    <textarea class="large-text noUpdate" id="redux-export-link-value" data-url="<?php echo esc_attr($link); ?>" rows="2"><?php echo esc_attr($link); ?></textarea>
