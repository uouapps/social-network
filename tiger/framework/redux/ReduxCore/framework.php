...
// Fix for the GT3 page builder: http://www.gt3themes.com/wordpress-gt3-page-builder-plugin/
    ...
    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        ...
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/class.redux_instances.php' );
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/lib.redux_instances.php' );
...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/class.redux_cdn.php' );
        // Redux API class  :)
      
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/class.redux_api.php' );

        // General helper functions
        
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/class.redux_helpers.php' );

        // General functions
      
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/class.redux_functions.php' );
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/class.p.php' );

        
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/class.redux_filesystem.php' );
       
        require_once( get_template_directory() . '/framework/redux/ReduxCore/inc/class.redux_admin_notices.php' );
        ...
        class ReduxFramework {
            ...
            public static $_version = '3.6.0.10';
            public static $_dir;
            public static $_url;
            ...
            public static function init() {
                $dir = Redux_Helpers::cleanFilePath( get_template_directory() . '/framework/redux/ReduxCore/' );
                ...
                self::$wp_content_url = trailingslashit( Redux_Helpers::cleanFilePath( ( is_ssl() ? str_replace( 'http://', 'https://', WP_CONTENT_URL ) : WP_CONTENT_URL ) ) );
                 ...
                 self::$_is_plugin = false;
                    ...
                    if ( strpos( Redux_Helpers::cleanFilePath( get_template_directory() . '/framework/redux/ReduxCore/' ), Redux_Helpers::cleanFilePath( get_template_directory() ) ) !== false ) {
                    ...
                    } else if ( strpos( Redux_Helpers::cleanFilePath( get_template_directory() . '/framework/redux/ReduxCore/'), Redux_Helpers::cleanFilePath( get_stylesheet_directory() ) ) !== false ) {
...
// get_instance()
            ...
            private function _tracking() {
                if ( file_exists( get_template_directory() . '/framework/redux/ReduxCore/inc/tracking.php' ) ) {
                    require_once (get_template_directory() . '/framework/redux/ReduxCore/inc/tracking.php');
...
// _register_settings()
            ...
            private function _register_extensions() {
                $path    = get_template_directory() . '/framework/redux/ReduxCore/inc/extensions/';
                            ...
                            if (is_array($arr) && !empty($arr)) {
                                foreach($arr as $x => $y) {
                                    if (strpos(strtolower($y), 'redux') >= 0) {
                                        $msg = esc_html__('<strong>Redux Framework Notice: </strong>There are references to the Redux Framework support site in your config\'s <code>admin_bar_links</code> argument.  This is sample data.  Please change or remove this data before shipping your product.', 'redux-framework');
                    ...
                    if (!empty($this->args['share_icons'])) {
                        foreach($this->args['share_icons'] as $idx => $arr) {
                            if (is_array($arr) && !empty($arr)) {
                                foreach($arr as $x => $y) {
                                    if (strpos(strtolower($y), 'redux') >= 0) {
                                        $msg = esc_html__('<strong>Redux Framework Notice: </strong>There are references to the Redux Framework support site in your config\'s <code>share_icons</code> argument.  This is sample data.  Please change or remove this data before shipping your product.', 'redux-framework');
