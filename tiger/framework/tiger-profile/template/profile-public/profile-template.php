<?php
//wp_enqueue_style('wp-uou_tigerp-piblic-11', wp_uou_tigerp_URLPATH . 'admin/files/css/iv-bootstrap.css');
wp_enqueue_style('uou_tigerp-style-64', wp_uou_tigerp_URLPATH . 'assets/cube/css/cubeportfolio.min.css');
wp_enqueue_style('user-public-profile-style', tiger_CSS.'user-public-profile.css', array(), $ver = false, $media = 'all');
        ...
        <div class="col-md-3 col-sm-4">
          <div class="profile-sidebar">
              ...
              <div class="profile-userpic text-center"> 
                  <?php			  	
					...
					<?php
					 ...
					 echo'	 <img src="'. wp_uou_tigerp_URLPATH.'assets/images/Blank-Profile.jpg" class="agent">';
					}
				  	?>  
                      </div>
              <!-- END SIDEBAR USERPIC -->
            ...
            <div class="portlet portlet0 light">
              ...
              <!-- END STAT -->
              <div>
                <h4 class="profile-desc-title"><?php esc_html_e('About','tiger'); ?>     <?php 
				   $name_display=get_user_meta($user_id,'first_name',true).' '.get_user_meta($user_id,'last_name',true);
				   echo (trim($name_display)!=""? $name_display : $display_name );?>
</h4>
                <span class="profile-desc-text"> <?php echo get_user_meta($user_id,'description',true); ?> </span>         
					...
					<strong class="desc-title"><?php esc_html_e('Phone','tiger'); ?> </strong><?php echo ''. get_user_meta($user_id,'phone',true); ?>
						 </div>
					<?php
					}
					...
					<strong class="desc-title"><?php esc_html_e('Mobile','tiger'); ?> </strong><?php echo ''. get_user_meta($user_id,'mobile',true); ?>
						 </div>
					<?php
					}
					...
					if( get_user_meta($user_id,'hide_email',true)==''){ ?>
						 ...
						 ><strong class="desc-title"><?php esc_html_e('Email','tiger'); ?> </strong>
            ...
            ?>
							...
							<strong class="desc-title"><?php esc_html_e('About','tiger'); ?> Website</strong>
							<?php  echo get_user_meta($user_id,'web_site',true);  ?>
							</a>
						 </div>
						 <h4 class="profile-desc-title"><?php esc_html_e('Social Profile','tiger'); ?> </h4>
              ...
              <div class="profile-content">
                  <div class="portlet-title tabbable-line clearfix">
                    <div class="caption caption-md">
                      ...
                      <span class="caption-subject font-blue-madison bold uppercase"><?php esc_html_e('User Listing','tiger'); ?> </span>
                    </div>
                  </div>
							...
							if(sizeof($total_post)>0){
								...
								foreach ( $authpr_post as $row )								
								{
									...
									if(has_post_thumbnail($id)){ 
										...
										$feature_img= wp_uou_tigerp_URLPATH."/assets/images/default-directory.jpg";					
											...
											<div class="cbp-caption-activeWrap">
												<div class="cbp-l-caption-alignCenter">
													<div class="cbp-l-caption-body">
														<div class="cbp-l-caption-text"><?php esc_html_e('VIEW DETAIL', 'tiger' ); ?></div>
													</div>
												</div>
											</div>
										</a>
