<?php
// wp_enqueue_style('wp-uou_tigerp-style-13', wp_uou_tigerp_URLPATH . 'admin/files/css/require 'lib/Stripe.php';';
wp_enqueue_script('uou_tigerp-script-upgrade-15', wp_uou_tigerp_URLPATH . 'admin/files/js/jquery.form-validator.js');
...
<script type="text/javascript" src="https://js.stripe.com/v2/"></script>
	...
	<div id="stripe_form">
			...
			<label for="text" class="col-md-4 col-xs-4 col-sm-4 control-label"><?php esc_html_e('Package Name',"tiger"); ?></label>
			...
			<div class="row form-group">
								<label for="text" class="col-md-4 col-xs-4 col-sm-4 control-label"><?php esc_html_e('Amount',"tiger"); ?></label>
			...
			<div class="row form-group">
								<label for="text" class="col-md-4 col-xs-4 col-sm-4 control-label"><?php esc_html_e('Card Number',"tiger"); ?></label> 
								<div class="col-md-8 col-xs-8 col-sm-8 " >  
									<input type="text" name="card_number" id="card_number"  data-validation="creditcard required"  class="form-control ctrl-textbox" placeholder="<?php esc_html_e('Enter card number',"tiger"); ?>" data-validation-error-msg="<?php esc_html_e('Card number is not correct',"tiger"); ?>" >
			</div>										
			</div>
		<div class="row form-group">
								<label for="text" class="col-md-4 col-xs-4 col-sm-4 control-label"><?php esc_html_e('Card CVV',"tiger"); ?> </label>
								<div class="col-md-8 col-xs-8 col-sm-8 " >  
									<input type="text" name="card_cvc" id="card_cvc" class="form-control ctrl-textbox"   data-validation="number" 
data-validation-length="2-6" data-validation-error-msg="<?php esc_html_e('CVV number is not correct',"tiger"); ?>" placeholder="<?php esc_html_e('Enter card CVC',"tiger"); ?>" >
			</div>
		</div>	
					<div class="row form-group">
							<label for="text" class="col-md-4 col-xs-4 col-sm-4 control-label"><?php esc_html_e('Expiration (MM/YYYY)',"tiger"); ?></label>
			 ...
			 data-validation-error-msg="You have to agree to our terms "  name="check_terms" id="check_terms"> <?php echo $term_text; ?>
				...
				<div class="row form-group">
					...
					<div class="col-md-8 col-xs-8 col-sm-8 " > <div id="loading"> </div> 
						<button  id="submit_uou_tigerp_payment"  type="submit" class="btn btn-info ctrl-btn"  > <?php esc_html_e('Submit',"tiger"); ?> </button>
					</div>
				</div>	
	</div>			
		...
		function stripeResponseHandler(status, response) {
			if (response.error) {				
				...
				// and submit
					...
					var search_params={
						"action"  : 	"uou_tigerp_profile_stripe_upgrade",	
