				...
				<?php
                  ...
                  <div class="filter-flower">
                    <div class="row">
                      <div class="col-sm-7">
                        <ul>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=bookmarker&follower-type=All" <?php echo($connection_type_follower=='All' ?'class="active"':'' ); ?> ><?php esc_html_e('Show All','tiger'); ?></a></li>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=bookmarker&follower-type=Professionals" <?php echo($connection_type_follower=='Professionals' ?'class="active"':'' ); ?> ><i class="fa fa-user"></i> <?php esc_html_e('Professionals','tiger'); ?></a></li>
                          <li><a href="<?php echo the_permalink();?>?&profile=bookmark&network=bookmarker&follower-type=Companies" <?php echo($connection_type_follower=='Companies' ?'class="active"':'' ); ?> ><i class="fa fa-building-o"></i> <?php esc_html_e('Companies','tiger'); ?></a></li>
                        </ul>
                      </div>
                  ...
                  <div class="main-mem"> 
                    ...
                    <div class="head">
                      <div class="row">
                        <div class="col-sm-8">
                          <button onclick="bookmarker_make_follow();" ><i class="fa fa-user-plus"></i><?php esc_html_e('Follow','tiger'); ?></button>
                          <button onclick="bookmarker_make_delete();"  ><i class="fa fa-trash"></i><?php esc_html_e('Delete','tiger'); ?></button>
                        </div>
                        <div class="col-sm-4">
                           <form action="<?php echo the_permalink().'?&profile=bookmark&network=bookmarker'; ?>" method="post"  >
 ...
 <script>
function bookmarker_make_follow(){
	var ajaxurl = '<?php echo admin_url('admin-ajax.php'); ?>';

	var search_params={
			"action"  : 	"uou_tigerp_bulk_bookmarker_make_follow",	
		...
		jQuery.ajax({					
			...
			success : function(response){		
				var url="<?php echo the_permalink(); ?>?&profile=bookmark&network=bookmarker";
				  location.href = url;				
...
function bookmarker_make_delete(){
	var ajaxurl = '<?php echo admin_url('admin-ajax.php'); ?>';
	

	var search_params={
			"action"  : 	"uou_tigerp_bulk_deletebookmarker",	
			"form_data":	jQuery("#follower_form_list").serialize(), 
		};
		jQuery.ajax({					
			url : ajaxurl,					 
