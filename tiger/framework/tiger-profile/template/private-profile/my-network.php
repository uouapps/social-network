...
?>
 <div class="network">
            <h4><?php esc_html_e('Network','tiger'); ?> </h4>
            
            <!-- Nav Tabs -->
            <ul class="nav nav-tabs">
              <li <?php echo ($network_tab =='connection'?'class="active"':'' ); ?> ><a data-toggle="tab" href="#connection"><?php esc_html_e('Connections','tiger'); 
                $socialnetwork_value='';
				...
				echo ' ('.sizeof($socialnetwork_value_arr).')';
              	?> </a></li>
              <li <?php echo ($network_tab=='follower'?'class="active"':'' ); ?> ><a data-toggle="tab" href="#follower"><?php esc_html_e('Followers','tiger'); ?> 
              <?php
               $socialnetwork_value='';
              ...
              <li  <?php echo ($network_tab=='following'?'class="active"':'' ); ?> ><a data-toggle="tab" href="#following"><?php esc_html_e('Following','tiger'); ?> 
              <?php
               $socialnetwork_value='';
            ...
            <div class="tab-content"> 
				...
				<?php
                  ...
                  <div class="filter-flower">
                    <div class="row">
                      <div class="col-sm-7">
                        <ul>
                          <li><a href="<?php echo the_permalink();?>?&profile=network&network=connection&type=All" <?php echo($connection_type=='All' ?'class="active"':'' ); ?> ><?php esc_html_e('Show All','tiger'); ?></a></li>
                          <li><a href="<?php echo the_permalink();?>?&profile=network&network=connection&type=Professionals" <?php echo($connection_type=='Professionals' ?'class="active"':'' ); ?> ><i class="fa fa-user"></i> <?php esc_html_e('Professionals','tiger'); ?></a></li>
                          <li><a href="<?php echo the_permalink();?>?&profile=network&network=connection&type=Companies" <?php echo($connection_type=='Companies' ?'class="active"':'' ); ?> ><i class="fa fa-building-o"></i> <?php esc_html_e('Companies','tiger'); ?></a></li>
                        </ul>
                      </div>
                    ...
                    <div class="head">
                      <div class="row">
                        <div class="col-sm-8">
                          ...
                          <button onclick="connection_make_delete_conection();"  ><i class="fa fa-trash"></i><?php esc_html_e('Delete','tiger'); ?></button>
                        </div>
                        <div class="col-sm-4">
						...
						if(sizeof($socialnetwork_value)>0){
							...
							if ( ! empty( $user_query->results ) ) {
								...
								if($total_pages_connection>1){
									...
									echo'<div class="text-center" id="add_more_connection_more_button"><button type="button" onclick="add_more_connection_ajax(2);"><i class="fa fa-plus"></i> '.esc_html__(' More','tiger').'</button> </div>';
								}
							} else {?>
								<li>
              ...
              <div id="follower" class="tab-pane fade  <?php echo ($network_tab =='follower'?'in active':'' ); ?> ">
				  <?php
				  include(  wp_uou_tigerp_template. 'private-profile/my-follower.php');
				  ?>
              ...
              <div id="following" class="tab-pane fade  <?php echo ($network_tab =='following'?'in active':'' ); ?> ">
				<?php
				  include(  wp_uou_tigerp_template. 'private-profile/following.php');
				  ?>
...
function connection_make_delete_conection(){
	...
	var search_params={
			"action"  : 	"uou_tigerp_bulk_connection_make_deleteconnection",	
			"form_data":	jQuery("#connection_form_list").serialize(), 
		};
		jQuery.ajax({					
			url : ajaxurl,					 
...
var total_page=<?php echo $total_pages_connection; ?>;	
	var loader_image = '<img src="<?php echo wp_uou_tigerp_URLPATH. "admin/files/images/loader.gif"; ?>" />';
		...
		var search_params={
			"action"  : 	"uou_tigerp_load_more_connection",	
