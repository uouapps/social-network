<div id="coupon-div" style="display: none;">
							...
							<label for="text" class="col-md-3 control-label"><?php  esc_html_e('Discount Coupon','tiger');?></label>
							...
							<div class="row form-group">
								<label for="text" class="col-md-3 control-label"><?php  esc_html_e('(-) Discount','tiger');?></label>
