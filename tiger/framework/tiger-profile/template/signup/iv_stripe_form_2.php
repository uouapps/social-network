	...
	<div id="payment-errors"></div>
			...
			<div class="row form-group">
							...
							<div class="row form-group" id="show_hide_div">
								...
								<div class="col-md-9 " > 
									<button type="button" onclick="show_coupon();"  class="btn btn-default center"><?php  esc_html_e('Have a coupon?','tiger');?></button>
								</div>
							</div>
							<?php
								include(wp_uou_tigerp_template.'signup/coupon_form_2.php');
			...
			<div class="row form-group">
								<label for="text" class="col-md-3 control-label"><?php  esc_html_e('Card Number','tiger');?><span class="chili"></span></label> 
								<div class="col-md-9 " >  
		...
		<div class="row form-group">
								<label for="text" class="col-md-3 control-label"><?php  esc_html_e('Card CVV ','tiger');?><span class="chili"></span></label>
								<div class="col-md-9 " >  
...
data-validation-length="2-6" data-validation-error-msg="CVV number is not correct"placeholder="Enter card CVC" >
		...
		<div class="row form-group">
								<label for="text" class="col-md-3 control-label"><?php  esc_html_e('Expiration (MM/YYYY)','tiger');?><span class="chili"></span></label>
								<div class="col-md-4 " >  
