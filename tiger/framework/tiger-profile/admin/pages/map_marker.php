...
<br/>
	...
	<form class="form-horizontal" role="form"  name='map_marker' id='map_marker'>
		 <h3  class="panel-heading"><?php _e('Hospital Category Image / Map Marker','tiger'); ?></h3> 
		<div class="row ">
			<div class="col-md-12 ">				 	
			<table class="table table-bordered table-hover table-responsive">												  
			  <thead>
				<tr>
				  <th><?php _e('Category Main','tiger'); ?>  </th>
				  <th><?php _e('Sub Category','tiger'); ?>  </th>
				  <th><?php _e('Map Marker','tiger'); ?> </th>
				   <th><?php _e('Category Image','tiger'); ?> </th>
				</tr>
			  </thead>
			  <tbody>
							...
							<td> 
								...
								<?php
									...
									if($marker!=''){
										...
										<img  width="20px" src="<?php echo  wp_uou_tigerp_URLPATH."/assets/images/map-marker/map-marker.png";?>">	
								<?php									
									}
								?>
								</div>
		...
		<h3  class=""><?php _e('Doctor Category Image / Map Marker','tiger'); ?> </h3> 	
		<div class="row ">
			<div class="col-md-12 ">
                ...
                image_gallery_frame.on( 'select', function() {
                    ...
                    selection.map( function( attachment ) {
                        ...
                        if ( attachment.id ) {							
							...
							var search_params = {
								"action": 	"uou_tigerp_update_map_marker",
                ...
                image_gallery_frame.on( 'select', function() {
                    ...
                    selection.map( function( attachment ) {
                        ...
                        if ( attachment.id ) {							
							var ajaxurl = '<?php echo admin_url('admin-ajax.php'); ?>';
							var search_params = {
								"action": 	"uou_tigerp_update_cate_image",
								"attachment_id": attachment.id,
								"category_id": cat_image_id,
							};
                             jQuery.ajax({
