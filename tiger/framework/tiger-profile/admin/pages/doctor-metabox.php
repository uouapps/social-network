		...
		//*************************	plugin file *********
 		...
 		<div class="row">
 			...
 			<div class="col-md-12"> <label>
 				<input type="checkbox" name="iv_doctor_approve" id="iv_doctor_approve" value="yes" <?php echo ($iv_doctor_approve=="yes" ? 'checked': "" )  ; ?> />  <strong><?php _e( 'Approve', 'uou_tigerp' )?></strong>
				</label>
 			</div> 
