...
<div class="form-group">
		...
		<div class="col-md-4 ">
				...
				<?php
				$uou_tigerp_contact_email_subject = get_option( 'uou_tigerp_contact_email_subject');
				?>
				
				<input type="text" class="form-control" id="contact_email_subject" name="contact_email_subject" value="<?php echo $uou_tigerp_contact_email_subject; ?>" placeholder="Enter subject">
...
<div class="form-group">
		...
		<div class="col-md-10 ">
					...
					$content_client = get_option( 'uou_tigerp_contact_email');
