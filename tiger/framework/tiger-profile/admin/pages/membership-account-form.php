	...
	function check_registration_form(){
						// validation
						var form_name = "#uou_tigerp_registration";
						var valid = 1;
						...
						if(valid == 1){
							...
							var search_params={
								...
								"action"  : "uou_tigerp_user_exist_check",
...
function update_registration_form() {
						...
						var search_params={
							"action"  : 				"uou_tigerp_update_form_registration", 
			...
			$form_meta_data_1= get_post_meta( $form_id,'uou_tigerp_content',true);
