	...
	function isValidEmailAddress(emailAddress) {
		...
		jQuery( ".droppedFields" ).sortable({
			...
			$form_meta_data= get_post_meta( $form_id,'uou_tigerp_content',true);
			...
			$uou_tigerp_width= get_post_meta( $form_id,'uou_tigerp_width',true);
			$digit1 = mt_rand(1,20);
			$digit2 = mt_rand(1,20);
			if( mt_rand(0,1) === 1 ) {
				$math = "$digit1 + $digit2";
				...
				<div class="welcome-panel container-fluid">
													...
													<div class="form-group">	
														<label for="text" class="col-md-4 control-label">Form Width</label>
															<div class="col-md-8">
																		...
																		<label class="radio">
																			<input type="radio" name="uou_tigerp_width" value="Responsive" id ="Responsive"  <?php echo ($uou_tigerp_width=='Responsive'? 'checked':''); ?> />Responsive
																		</label>
																		<label class="radio">
																			<input type="radio" name="uou_tigerp_width" id ="fixed_width"  value="custom_width" <?php echo($uou_tigerp_width!='Responsive'? 'checked':''); ?> />
																			Fixed Width
																		<input type="text"  id="uou_tigerp_width-input" name="uou_tigerp_width-input" class="form-control col-md-4"  value="<?php echo ($uou_tigerp_width!='Responsive'? $uou_tigerp_width :''); ?>" placeholder="Enter Form Width  Like 500px"  style="display: none" >
																		</label>
					...
					<!-- End Form 101-->
						<div class="row">
							<div class="col-md-5">
								...
								<div class="col-md-8">
									<?php
									$uou_tigerp_admin_email_subject = get_post_meta( $form_id,'uou_tigerp_admin_email_subject',true);
									?>
							...
							<div class="col-md-6">
								...
								<div class="col-md-8">
									<?php
									$uou_tigerp_auto_email_subject = get_post_meta( $form_id,'uou_tigerp_auto_email_subject',true);
									?>
					...
					<div class="row">
						<div class="col-md-5">
							...
							<a data-toggle="modal" href="<?php echo wp_uou_tigerp_URLPATH; ?>admin/pages/template_email_modal.php?upath=<?php echo wp_uou_tigerp_URLPATH; ?>" data-target="#modal_template_help"><img  title="Template Preview" class="caption-help  right"  height="30px" src="<?php echo wp_uou_tigerp_URLPATH; ?>admin/files/images/eye-open-128.png"></a></small></h3> 
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										...
										$uou_tigerp_email_template_type=get_post_meta( $form_id,'uou_tigerp_email_template_type',true);
										
										?>
										<select class="form-control" id="all-tempalte" name="all-tempalte">
											<option value="green" <?php echo ($uou_tigerp_email_template_type=='green'? 'selected': '') ?>>Green [Contact Us]</option>
											<option value="black_white" <?php echo ($uou_tigerp_email_template_type=='black_white'? 'selected': '') ?>>Black & White [Contact Us]</option>
											<option value="textile" <?php echo ($uou_tigerp_email_template_type=='textile'? 'selected': '') ?>>Textile [Contact Us]</option>
											<option value="newsletter_green" <?php echo ($uou_tigerp_email_template_type=='newsletter_green'? 'selected': '') ?> >Green [Newsletter]</option>
										</select>
									</div>
								</div>
						</div>	
					...
					<div class="row">					
						...
						<div class="col-md-6">
							...
							<div class="email-wrap">
								...
								$content_admin = get_post_meta( $form_id,'uou_tigerp_admin_email',true);
							...
							<div class="col-md-6 ">
								...
								<div class="col-md-12 email-wrap">
									...
									$content_client = get_post_meta( $form_id,'uou_tigerp_auto_email',true);
