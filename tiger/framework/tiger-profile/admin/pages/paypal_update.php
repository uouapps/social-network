...
<script>
	...
	function update_paypal_setting() {
				...
				// New Block For Ajax*****
				var search_params={
					"action"  : 	"uou_tigerp_update_paypal_settings",	
				...
				jQuery.ajax({					
					...
					success : function(response){
						jQuery('#iv-loading').html('<div class="col-md-5 alert alert-success">Update Successfully. <a class="btn btn-success btn-xs" href="?page=wp-uou_tigerp-payment-settings"> Go Payment Setting Page</aa></div>');
			...
			$paypal_mode=get_post_meta( $newpost_id,'uou_tigerp_paypal_mode',true);	
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
							  ...
							  <div class="form-group">
								...
								<div class="col-md-5">
								  <input type="text" class="form-control" name="paypal_username" id="paypal_username" value="<?php echo get_post_meta($newpost_id, 'uou_tigerp_paypal_username', true); ?>" placeholder="Enter Paypal Username">
								</div>
							  </div>
							  ...
							  <div class="form-group">
								...
								<div class="col-md-5">
								  <input type="text" class="form-control" id="paypal_api_password" name="paypal_api_password" value="<?php echo get_post_meta($newpost_id, 'uou_tigerp_paypal_api_password', true); ?>"  placeholder="Enter Paypal Api Password">
								</div>
							  </div>
								...
								<div class="col-md-5">
								  <input type="text" class="form-control" id="paypal_api_signature" name="paypal_api_signature" value="<?php echo get_post_meta($newpost_id, 'uou_tigerp_paypal_api_signature', true); ?>"  placeholder="Enter Paypal Api Signature">
								</div>
							  </div>
							  <div class="form-group">
								...
								<div class="col-md-5">
									<?php
										$currency_iv=get_post_meta($newpost_id, 'uou_tigerp_paypal_api_currency', true);
									?>
									...
									<!--
								  <input type="text" class="form-control" id="paypal_api_currency" name="paypal_api_currency" value="<?php echo get_post_meta($newpost_id, 'uou_tigerp_paypal_api_currency', true); ?>"  placeholder="Enter Paypal Api Currency">
								  -->
								</div>
							  </div>
