								...
								<div class="panel-body">
										...
										<div class="row ">
											...
											<div class="col-sm-2">
												...
												<label><?php
													 $account_menu_check='';
													 if( get_option( '_uou_tigerp_menu_listinghome' ) ) {
														  $account_menu_check= get_option('_uou_tigerp_menu_listinghome'); 
													 }	 
										...
										<div class="row ">
											...
											<div class="col-sm-2">
												...
												<label><?php
													 $account_menu_check='';
													 if( get_option( '_uou_tigerp_menufavorites' ) ) {
														  $account_menu_check= get_option('_uou_tigerp_menufavorites'); 
													 }	 
													 //echo  $t_terms;
													?>
...
<script>
	...
	function update_profile_fields(){
		...
		var search_params = {
			"action": 		"uou_tigerp_update_profile_fields",
