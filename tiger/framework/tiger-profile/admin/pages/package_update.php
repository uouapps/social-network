...
<script>
	...
	function update_the_package() {
		...
		jQuery("#loading").html(loader_image);
				...
				var search_params={
					"action"  : 	"uou_tigerp_update_package",	
				...
				jQuery.ajax({					
					...
					success : function(response){						
						var url = "<?php echo wp_uou_tigerp_ADMINPATH; ?>admin.php?page=wp-uou_tigerp-package-all&form_submit=success";    						
				...
				<div class="welcome-panel container-fluid">
					...
					<!--
						...
						<form id="package_form_iv" name="package_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
							  ...
							  <div class="form-group "  >									
								<label for="text" class="col-md-2 control-label"><?php  esc_html_e('Package for','tiger');?></label>
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="corporate" <?php echo (get_post_meta($package_id, 'uou_tigerp_user_type', true)=='corporate'?'checked' : '' ); ?>  > <?php  esc_html_e('Corporate','tiger');?> </label>
								</div>
								
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="professional"  <?php echo (get_post_meta($package_id, 'uou_tigerp_user_type', true)=='professional'?'checked' : '' ); ?> ><?php  esc_html_e(' Professional','tiger');?> </label>
								</div>
								<!--								
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="personal" <?php echo (get_post_meta($package_id, 'uou_tigerp_user_type', true)=='personal'?'checked' : '' ); ?> ><?php  esc_html_e(' Personal','tiger');?> </label>
								</div>	
								-->							
							</div>	
							  ...
							  <div class="form-group">
								...
								<div class="col-md-6">
								  <input type="text" class="form-control" id="package_cost" name="package_cost" value="<?php echo get_post_meta($package_id, 'uou_tigerp_package_cost', true); ?>"  placeholder="Enter Initial Payment">The Initial Amount Collected at User Registration.
								</div>
							  </div>
								...
								<div class="col-md-2">
								  <select id="package_initial_expire_interval" name="package_initial_expire_interval" class="ctrl-combobox form-control">
										...
										<?php
											  $package_initial_period_interval= get_post_meta($package_id, 'uou_tigerp_package_initial_expire_interval', true); 
									...
									<div class="col-md-4">
										<?php
											 $package_initial_expire_type= get_post_meta($package_id, 'uou_tigerp_package_initial_expire_type', true); 
											 ?>
							   ...
							   <div class="form-group">
								...
								<div class="col-md-6 ">
									<label>
									  <input type="checkbox"  <?php echo (get_post_meta($package_id, 'uou_tigerp_package_recurring', true)=='on'?'checked': ''); ?> name="package_recurring" id="package_recurring" value="on" > Enable Recurring Payment
									</label>
								</div>								
							  </div>
					<div id="recurring_block" style="display:<?php echo (get_post_meta($package_id, 'uou_tigerp_package_recurring', true)=='on'?'': 'none'); ?>" >		  
							   <div class="form-group">
								<label for="text" class="col-md-2 control-label">Billing Amount</label>
								<div class="col-md-2">
								  <input type="text" class="form-control" value="<?php echo get_post_meta($package_id, 'uou_tigerp_package_recurring_cost_initial', true); ?>" name ="package_recurring_cost_initial" id="package_recurring_cost_initial" placeholder="Amount">
								</div>
								<label for="text" class="col-md-1 control-label">Per</label>
								<div class="col-md-1">									
								   <input type="text" class="form-control" value="<?php echo get_post_meta($package_id, 'uou_tigerp_package_recurring_cycle_count', true); ?>" id="package_recurring_cycle_count" name="package_recurring_cycle_count" placeholder="Cycle #">
								</div>
									<div class="col-md-2">
										<?php $package_recurring_cycle_type= get_post_meta($package_id, 'uou_tigerp_package_recurring_cycle_type', true); ?>
							   ...
							   <div class="form-group">
								...
								<div class="col-md-2">
										<select name="package_recurring_cycle_limit" id ="package_recurring_cycle_limit" class="ctrl-combobox form-control">	
											...
											<?php
											 $package_recurring_cycle_limit= get_post_meta($package_id, 'uou_tigerp_package_recurring_cycle_limit', true); 
											for($ii=1;$ii<35;$ii++){
								...
								<div class="col-md-6 ">
									<label>
									  <input type="checkbox" <?php echo (get_post_meta($package_id, 'uou_tigerp_package_enable_trial_period', true)=='yes'? 'checked': ''); ?> name="package_enable_trial_period" id="package_enable_trial_period" value='yes'> Enable Trial Period
									</label>
									<br/>
									 "Billing Amount" will Collect After Trial Period.   
								</div>								
							  </div>
					<div id="trial_block" style="display:<?php echo (get_post_meta($package_id, 'uou_tigerp_package_enable_trial_period', true)=='yes'? '': 'none'); ?>" >		  
							   <div class="form-group">
								<label for="inputEmail3" class="col-md-2 control-label">Trial Amount</label>
								<div class="col-md-6">
								  <input type="text" class="form-control" value="<?php echo get_post_meta($package_id, 'uou_tigerp_package_trial_amount', true); ?>" id="package_trial_amount" name="package_trial_amount" placeholder="Enter Amount to Bill for The Trial Period">
							  ...
							  <div class="form-group">
								...
								<div class="col-md-2">
								  <select id="package_trial_period_interval" name="package_trial_period_interval" class="ctrl-combobox form-control">
										...
										<?php
											 $package_trial_period_interval= get_post_meta($package_id, 'uou_tigerp_package_trial_period_interval', true); 
											for($ii=1;$ii<31;$ii++){
									...
									<div class="col-md-4">
										<?php
											 $package_recurring_trial_type= get_post_meta($package_id, 'uou_tigerp_package_recurring_trial_type', true); 
											 ?>
						...
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_event" id="listing_event"  value='yes'  <?php echo (get_post_meta($package_id,'uou_tigerp_package_event',true)=='yes'?'checked':'' ); ?>> <?php _e('Can Add Event.','tiger'); ?>
								</label>
						...
						<div class="form-group">
							<label for="text" class="col-md-2 control-label"> <?php _e("Hospital's Doctor",'tiger'); ?> </label>
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_doctor" id="listing_doctor"  value='yes' <?php echo (get_post_meta($package_id,'uou_tigerp_package_doctor',true)=='yes'?'checked':'' ); ?>> <?php _e('Can Add doctors list.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						
						<div class="form-group">
							<label for="text" class="col-md-2 control-label"> <?php _e('listing Videos','tiger'); ?> </label>
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_video" id="listing_video"  value='yes'  <?php echo (get_post_meta($package_id,'uou_tigerp_package_video',true)=='yes'?'checked':'' ); ?> > <?php _e('Can Add Videos.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						<div class="form-group">
							<label for="text" class="col-md-2 control-label"> <?php _e('listing Award','tiger'); ?> </label>
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_award" id="listing_award"  value='yes'  <?php echo (get_post_meta($package_id,'uou_tigerp_package_award',true)=='yes'?'checked':'' ); ?> > <?php _e('Can Add Award.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						
						<div class="form-group">
							<label for="text" class="col-md-2 control-label"> <?php _e('Doctor Appointment','tiger'); ?> </label>
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_booking" id="listing_booking"  value='yes'  <?php echo (get_post_meta($package_id,'uou_tigerp_package_booking',true)=='yes'?'checked':'' ); ?> > <?php _e('Can Add Doctor Appointment Shortcode','tiger'); ?> 
								</label>								 										
							</div>																
						</div>
