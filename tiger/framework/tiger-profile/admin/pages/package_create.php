<script>
	...
	function save_the_form() {
		...
		jQuery("#loading").html(loader_image);
				...
				// New Block For Ajax*****
				var search_params={
					"action"  : 	"uou_tigerp_save_package",	
				...
				<div class="welcome-panel container-fluid">
					...
					<div class="row">					
						<div class="col-xs-12" id="submit-button-holder">					
							<div class="pull-right"><button class="btn btn-info btn-lg" onclick="return save_the_form();"><?php _e('Save Package','tiger'); ?></button></div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12"><h3 class="page-header"><?php _e('Create Package / Membership Level','tiger'); ?> <br /><small> &nbsp;</small> </h3>
						</div>							
					...
					<!--
						...
						<form id="package_form_iv" name="package_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
							  ...
							  <div class="form-group">
								<label for="text" class="col-md-2 control-label"><?php _e('Package Name','tiger'); ?></label>
								<div class="col-md-6">
							  ...
							  <div class="form-group "  >									
								...
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="corporate"  checked > <?php  esc_html_e('Corporate','tiger');?> </label>
								</div>
								
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="professional"   ><?php  esc_html_e(' Professional','tiger');?> </label>
								</div>	
								<!--							
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="personal" ><?php  esc_html_e(' Personal','tiger');?> </label>
								</div>	
								-->							
							</div>	
							
							   <div class="form-group ">
								<label for="text" class="col-md-2 control-label"><?php _e('Package Feature List','tiger'); ?></label>
								<div class="col-md-6">
									<textarea class="form-control" name="package_feature" id="package_feature" rows="5" placeholder="Enter Feature List "></textarea>
								    <?php _e('It will display on price list table','tiger'); ?> 
								</div>
							  </div>
							  <h3 class="page-header"> <?php _e('Billing Details','tiger'); ?></h3>
							 
							  <div class="form-group">
								<label for="inputEmail3" class="col-md-2 control-label"><?php _e('Initial Payment','tiger'); ?></label>
								<div class="col-md-6">
								  <input type="text" class="form-control" id="package_cost" name="package_cost" placeholder="Initial Payment (only number , no currency)">
								  <?php _e('The initial amount collected at user registration.','tiger'); ?>
								</div>
							  </div>
							  
							   <div class="form-group">
								<label for="text" class="col-md-2 control-label"><?php _e('Package Expire After','tiger'); ?></label>
								<div class="col-md-2">
								  <select id="package_initial_expire_interval" name="package_initial_expire_interval" class="ctrl-combobox form-control">
									...
									<?php _e('If select none then user package will expire after 19 years. Package Expire Option will not work on Recurring Subscription. "Billing Cycle Limit" will Work For Recurring Subscription.','tiger'); ?>
								   ...
								   <div class="form-group">
									<label for="text" class="col-md-2 control-label"> <?php _e('Recurring Subscription','tiger'); ?></label>
									<div class="col-md-6 ">
										<label>
										  <input type="checkbox" name="package_recurring" id="package_recurring" value="on" > <?php _e('Enable Recurring Payment','tiger'); ?>
										</label>
									</div>								
								  </div>
				<div id="recurring_block" style="display:none" >	  
								   <div class="form-group">
									<label for="text" class="col-md-2 control-label"><?php _e('Billing Amount','tiger'); ?></label>
									<div class="col-md-2">
									...
									<label for="text" class="col-md-1 control-label"><?php _e('Per','tiger'); ?></label>
									<div class="col-md-1">									
									   <input type="text" class="form-control" id="package_recurring_cycle_count" name="package_recurring_cycle_count" placeholder="Cycle #">
										...
										<div class='col-md-12'><label for="text" class="col-md-2 control-label"></label>
											<?php _e('The "Billing Amount" will Collect at User Registration.','tiger'); ?>
										</div>
									  </div>
							  
							   <div class="form-group">
								<label for="text" class="col-md-2 control-label"><?php _e('Billing Cycle Limit','tiger'); ?></label>
								...
								<div class="form-group">
									<label for="text" class="col-md-2 control-label"> <?php _e('Trial','tiger'); ?></label>
									<div class="col-md-6 ">
										<label>
										  <input type="checkbox" name="package_enable_trial_period" id="package_enable_trial_period"  value='yes'> <?php _e('Enable Trial Period','tiger'); ?>
										</label>
										<br/>
										<?php _e('"Billing Amount" will Collect After Trial Period. ','tiger'); ?> 
						...
						<div id="trial_block" style="display:none" >
									   ...
									   <div class="form-group">
										<label for="inputEmail3" class="col-md-2 control-label"><?php _e('Trial Amount','tiger'); ?></label>
										<div class="col-md-6">
										  <input type="text" class="form-control" id="package_trial_amount" name="package_trial_amount" placeholder="Enter Amount to Bill for The Trial Period">
											<?php _e('Amount to Bill for The Trial Period. Free is 0.[Stripe will not support this option ]','tiger'); ?>
										</div>
									  </div>
									  
									  <div class="form-group">
										<label for="text" class="col-md-2 control-label"><?php _e('Trial Period','tiger'); ?></label>
										<div class="col-md-2">
										  <select id="package_trial_period_interval" name="package_trial_period_interval" class="ctrl-combobox form-control">
											...
											<div class='col-md-12'><label for="text" class="col-md-2 control-label"></label>
												<?php _e('After The Trial Period "Billing Amount"	Will Be Billed.','tiger'); ?>	
											</div>
						...
						<h3 class="page-header"> <?php _e('Access Control/Options','tiger'); ?> </h3>
						 ...
						 <div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_hide" id="listing_hide"  value='yes'> <?php _e('Company/professional will hide after user subscription expire.','tiger'); ?>
								</label>																	
							</div>																
						</div> 
						 <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_event" id="listing_event"  value='yes'> <?php _e('Can Add Event.','tiger'); ?>
								</label>
						...
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_doctor" id="listing_doctor"  value='yes'> <?php _e('Can Add doctors list.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						...
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_video" id="listing_video"  value='yes'> <?php _e('Can Add Videos.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_award" id="listing_award"  value='yes'> <?php _e('Can Add Award.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						...
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_booking" id="listing_booking"  value='yes'  > <?php _e('Can Add Doctor Appointment Shortcode','tiger'); ?> 
								</label>								 										
							</div>																
						</div>
						-->
						...
						<div class="row">					
							<div class="col-xs-12">					
								<div align="center">
									<div id="loading"></div>
									<button class="btn btn-info btn-lg" onclick="return save_the_form();"><?php _e('Save Package','tiger'); ?></button></div>
									<p>&nbsp;</p>
								</div>
							</div>
						</div>
