	...
	jQuery(document).ready(function(){
		jQuery("#submit_uou_tigerp_payment").on("click",function(){
						// validation
						
						
						var form_name = "#uou_tigerp_payment";
						var valid = 1;
						...
						if(valid == 1){
							...
							var search_params={
								"action"  : "uou_tigerp_payment_submit",
...
function update_payment_form() {
						...
						var search_params={
							"action"  : 				"uou_tigerp_update_form_payment", 
			...
			global $wpdb;
			$form_id='';
			$form_name='uou_tigerp_payment_form';
