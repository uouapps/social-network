...
// For Template ****
update_option('uou_tigerp_reminder_email', $reminder_email_template  ); 

// For Subject ****

$reminder_subject = get_bloginfo().': Subscription Reminder ';
update_option('uou_tigerp_reminder_email_subject', $reminder_subject ); 
update_option('uou_tigerp_reminder_day', '10'); 
...
/*		
	...
	$page_content='[uou_tigerp_reminder_email_cron]';
	$my_post_form = array(
	...
	update_option('_uou_tigerp_remainder_email_page', $newpost_id);
