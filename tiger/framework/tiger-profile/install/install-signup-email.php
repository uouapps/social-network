...
update_option('uou_tigerp_signup_email', trim($client_signup_email_template)  ); 


$signup_subject = 'Welcome To '.get_bloginfo();

update_option('uou_tigerp_signup_email_subject', $signup_subject  ); 
...
update_option('uou_tigerp_forget_email', trim($client_forget_email_template)  ); 
$forget_subject = 'Forget Password '.get_bloginfo();
update_option('uou_tigerp_forget_email_subject', $forget_subject  ); 
...
update_option('uou_tigerp_contact_email', trim($contact_email_template)  ); 
$contact_subject = 'New Message '.get_bloginfo();
update_option('uou_tigerp_contact_email_subject', $contact_subject  ); 
...
update_option('tiger_contact_us_email', trim($contact_us_email_template) ); 
$contact_us_email_subject = 'Contact Us Message '.get_bloginfo();
update_option('tiger_contact_us_email_subject', $contact_us_email_subject); 
...
update_option('tiger_contact_us_email_client', trim($contact_us_email_template)  ); 
$contact_us_email_subject = 'Thank You '.get_bloginfo();
update_option('tiger_contact_us_email_subject_client', $contact_us_email_subject  );
