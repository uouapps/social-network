<?php
global $wpdb;			
	$email_body_cilent = get_option( 'uou_tigerp_order_client_email');
	$order_email_subject_client = get_option( 'uou_tigerp_order_client_email_sub');			
	...
	$dis_amount =get_user_meta($userId, 'uou_tigerp_discount',true);
	
	$package_amount_2=$uou_tigerp_package_cost.' '.$api_currency;
	...
	$total_g =(($uou_tigerp_package_cost+ $total_tax) - $dis_amount).' '.$api_currency;
	...
	// For Admin Email*****	
	$email_body_admin = get_option( 'uou_tigerp_order_admin_email');
	$order_email_subject_admin = get_option( 'uou_tigerp_order_admin_email_sub');			
