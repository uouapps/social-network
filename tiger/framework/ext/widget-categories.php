...
class tiger_Categories extends WP_Widget {

    function __construct() {
        $widget_ops = array( 'classname' => 'tiger_widget_categories', 'description' => esc_html__( "Styled list  of categories.",'tiger'  ) );
        parent::__construct('tiger_categories', esc_html__('tiger Categories','tiger' ), $widget_ops);
    }
...
add_action('widgets_init', 'tiger_categories');

function tiger_categories(){
    register_widget('tiger_Categories');
}
