 ...
 * @since 2.8.0
 */
class tiger_Social extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'tiger_widget_tiger_social', 'description' => esc_html__('Arbitrary text or HTML.','tiger'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('tiger_tiger_social', esc_html__('tiger Social ','tiger'), $widget_ops, $control_ops);
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('facebook')); ?>"><?php esc_html_e('Facebook Profile Link:','tiger'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('twitter')); ?>"><?php esc_html_e('Twitter Profile Link:','tiger'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('linkedin')); ?>"><?php esc_html_e('Linkedin Profile Link:','tiger'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('googleplus')); ?>"><?php esc_html_e('GooglePlus Profile Link:','tiger'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php esc_html_e('Pinterest Profile Link:','tiger'); ?></label>
...
add_action('widgets_init', 'tiger_social');

function tiger_social(){

    register_widget('tiger_Social');
