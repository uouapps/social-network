 ...
 * @since 2.8.0
 */
class tiger_Legal extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'tiger_widget_tiger_legal', 'description' => esc_html__('Arbitrary text or HTML.','tiger'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('tiger_tiger_legal', esc_html__('tiger Legal ','tiger'), $widget_ops, $control_ops);
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('story')); ?>"><?php esc_html_e('Our Privacy & Policy Link:','tiger'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('mission')); ?>"><?php esc_html_e('Terms & Conditions Link:','tiger'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('journal')); ?>"><?php esc_html_e('Secure Payments Link:','tiger'); ?></label>
...
add_action('widgets_init', 'tiger_legal');

function tiger_legal(){

    register_widget('tiger_Legal');
