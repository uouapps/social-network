 ...
 * @since 2.8.0
 */
class tiger_Widget_Tag_Cloud extends WP_Widget {

	public function __construct() {
		$widget_ops = array( 'description' => esc_html__( "A cloud of your most used tags.",'tiger') );
		parent::__construct('tag_cloud', esc_html__('tiger Tag Cloud','tiger'), $widget_ops);
	}
...
?>
	...
	<p><label for="<?php echo esc_attr($this->get_field_id('taxonomy')); ?>"><?php esc_html_e('Taxonomy:','tiger') ?></label>
...
add_action('widgets_init', 'tiger_tag');

function tiger_tag(){
    register_widget('tiger_Widget_Tag_Cloud');
}
