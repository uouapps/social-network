			...
			<div class="bootstrap-wrapper">
				<div class="welcome-panel container-fluid">
						<div class="row">
							...
							<div class="col-md-12"><h3 class="page-header"><?php _e('Profile Fields','tiger'); ?>  <br /><small> &nbsp;</small> </h3>
							</div>
						</div> 
						...
						<div class="panel-heading"><h4><?php _e('Personal Profile Fields','tiger'); ?>  </h4></div>
