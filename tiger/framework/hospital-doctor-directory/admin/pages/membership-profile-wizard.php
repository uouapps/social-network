	...
	<div class="welcome-panel container-fluid">
		...
		<div class="form-group col-md-12 row">
			...
			<div class="row ">
				...
				<div class="col-md-10" >	
					<a class="btn btn-primary btn-xs" href="?page=wp-iv_directories-profile-fields"><?php _e('Add /Edit/ Remove Profile Fields','tiger');?>   </a>
			...
			<div class="row ">
				...
				<div class="col-md-10" >	
					<a class="btn btn-primary btn-xs" href="?page=wp-iv_directories-profile-fields"> <?php _e('Show/Hide/Add Menu','tiger');?> </a>
