				...
				<div class="welcome-panel container-fluid">
					...
					<!--
						...
						<form id="package_form_iv" name="package_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
							  ...
							  <div class="form-group "  >									
								...
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="corporate" <?php echo (get_post_meta($package_id, 'iv_directories_user_type', true)=='corporate'?'checked' : '' ); ?>  > <?php  esc_html_e('Corporate','tiger');?> </label>
								</div>
								
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="professional"  <?php echo (get_post_meta($package_id, 'iv_directories_user_type', true)=='professional'?'checked' : '' ); ?> ><?php  esc_html_e(' Professional','tiger');?> </label>
								</div>
								<!--								
								<div class="col-md-2">
									<label><input type="radio"  name="iv_member_type"  id="iv_member_type" value="personal" <?php echo (get_post_meta($package_id, 'iv_directories_user_type', true)=='personal'?'checked' : '' ); ?> ><?php  esc_html_e(' Personal','tiger');?> </label>
								</div>	
								-->							
							</div>	
					...
					<!--
						 ...
						 <div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_hide" id="listing_hide"  value='yes' <?php echo (get_post_meta($package_id,'iv_directories_package_hide_exp',true)=='yes'?'checked':'' ); ?>> <?php _e('listing will hide after user subscription expire.','tiger'); ?>
								</label>																	
							</div>																
						</div> 
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_event" id="listing_event"  value='yes'  <?php echo (get_post_meta($package_id,'iv_directories_package_event',true)=='yes'?'checked':'' ); ?>> <?php _e('Can Add Event.','tiger'); ?>
								</label>
						...
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_doctor" id="listing_doctor"  value='yes' <?php echo (get_post_meta($package_id,'iv_directories_package_doctor',true)=='yes'?'checked':'' ); ?>> <?php _e('Can Add doctors list.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						...
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_video" id="listing_video"  value='yes'  <?php echo (get_post_meta($package_id,'iv_directories_package_video',true)=='yes'?'checked':'' ); ?> > <?php _e('Can Add Videos.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_award" id="listing_award"  value='yes'  <?php echo (get_post_meta($package_id,'iv_directories_package_award',true)=='yes'?'checked':'' ); ?> > <?php _e('Can Add Award.','tiger'); ?>
								</label>								 										
							</div>																
						</div> 
						...
						<div class="form-group">
							...
							<div class="col-md-6 ">
								<label>
								  <input type="checkbox" name="listing_booking" id="listing_booking"  value='yes'  <?php echo (get_post_meta($package_id,'iv_directories_package_booking',true)=='yes'?'checked':'' ); ?> > <?php _e('Can Add Doctor Appointment Shortcode','tiger'); ?> 
								</label>								 										
							</div>																
						</div>
						-->
