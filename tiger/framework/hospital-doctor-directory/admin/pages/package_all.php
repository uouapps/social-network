			...
			<div class="row ">					
				<div class="col-md-12" id="submit-button-holder">					
					<div class="pull-right ">								
						...
						<a class="btn btn-info "  href="<?php echo wp_iv_directories_ADMINPATH; ?>admin.php?page=wp-iv_directories-package-create"><?php _e( 'Create A New Package', 'tiger' ); ?></a>
					</div>
				</div>
			</div>
								...
								<li class="list-group-item">
									...
									<?php 
											$iv_directories_price_table=get_option('_iv_directories_price_table');
											  ?>
											<a class="btn btn-info btn-xs " href="<?php echo get_permalink( $iv_directories_price_table ); ?>" target="blank"><?php _e( 'View Page', 'tiger' ); ?></a>
