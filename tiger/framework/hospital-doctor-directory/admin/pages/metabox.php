		...
		//*************************	plugin file *********
 		...
 		<div class="row">
 			...
 			<div class="col-md-12"> <label>
 				<input type="checkbox" name="iv_hospital_approve" id="iv_hospital_approve" value="yes" <?php echo ($iv_hospital_approve=="yes" ? 'checked': "" )  ; ?> />  <strong><?php _e( 'Approve', 'iv_directories' )?></strong>
				</label>
 			</div> 
