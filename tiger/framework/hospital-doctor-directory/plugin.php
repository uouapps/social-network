  ...
  if (!class_exists('wp_iv_directories')) {  	
			...
			private static $instance;			
				...
				public function __construct() {
					...
					add_action('wp_ajax_iv_directories_load_more_following', array(&$this, 'iv_directories_load_more_following'));
					add_action('wp_ajax_nopriv_iv_directories_load_more_following', array(&$this, 'iv_directories_load_more_following'));
					
					add_action('wp_ajax_iv_directories_bulk_following_make_unfollow', array(&$this, 'iv_directories_bulk_following_make_unfollow'));
					add_action('wp_ajax_nopriv_iv_directories_bulk_following_make_unfollow', array(&$this, 'iv_directories_bulk_following_make_unfollow'));
					
					add_action('wp_ajax_iv_directories_bulk_following_make_connect', array(&$this, 'iv_directories_bulk_following_make_connect'));
					add_action('wp_ajax_nopriv_iv_directories_bulk_following_make_connect', array(&$this, 'iv_directories_bulk_following_make_connect'));
					...
					add_action('wp_ajax_iv_directories_load_more_bookmark', array(&$this, 'iv_directories_load_more_bookmark'));
					add_action('wp_ajax_nopriv_iv_directories_load_more_bookmark', array(&$this, 'iv_directories_load_more_bookmark'));						
					add_action('wp_ajax_iv_directories_load_more_bookmarker', array(&$this, 'iv_directories_load_more_bookmarker'));
					add_action('wp_ajax_nopriv_iv_directories_load_more_bookmarker', array(&$this, 'iv_directories_load_more_bookmarker'));						
			...
			public function iv_directories_update_doctor(){
				...
				*/
				...
				public function iv_directories_load_more_bookmark(){
						global $current_user;
						parse_str($_POST['data'], $form_data);	
						$paged =$form_data['page'];
						$connection_type =$form_data['type'];
				...
				public function iv_directories_load_more_bookmarker(){
						global $current_user;
						parse_str($_POST['data'], $form_data);	
						$paged =$form_data['page'];
						$connection_type =$form_data['type'];
				...
				public function iv_directories_load_more_following(){
						global $current_user;
						parse_str($_POST['data'], $form_data);	
						$paged =$form_data['page'];
						$connection_type =$form_data['type'];
