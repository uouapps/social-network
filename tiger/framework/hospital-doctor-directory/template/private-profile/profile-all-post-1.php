...
wp_enqueue_style('all-post-style', tiger_CSS.'all-post.css', array(), $ver = false, $media = 'all');
?>    
                  ...
                  <div class="portlet-body">
					...
					<div class="table-responsive listing-table">
					 <table class="table table-striped ">
							...
							<tr class="table-head">
								<th><?php  esc_html_e('Title','tiger');?></th>								
								<th><?php  esc_html_e('Status','tiger');?></th>
								<th><?php  esc_html_e('Type','tiger');?></th>
								<th><?php  esc_html_e('Expire','tiger');?></th>
								<th><?php  esc_html_e('Actions','tiger');?></th>
							</tr>
							...
							<?php
								...
								<?php 
										...
										<tr>
											<td colspan="100%">
											<?php esc_html_e('Currently you have no listings added. Please manage your account from the sidebar on the left.','tiger'); ?>
											</td>
										</tr>
									<?php
									}	
