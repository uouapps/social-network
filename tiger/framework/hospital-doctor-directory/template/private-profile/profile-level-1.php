              ...
              <div class="portlet light">
                  <div class="portlet-title tabbable-line clearfix">
                    <div class="caption caption-md">
                      <span class="caption-subject"><?php  _e('Membership Level','tiger')	;?>	 </span>
                    </div>
						  ...
						  <div class="table-responsive">
							...
							<tr>
							 ...
							 ?>
								...
								<tr>
									<td width="40%" style="font-size:14px"> 
										<?php  _e('Next Payment Date','tiger')	;?>
									</td>
									<td width="60%" style="font-size:14px"> 
									<?php
										if($recurring == 'on'){
									...
									if($payment_gateway=='paypal-express'){	
										...
										$profile_id = get_user_meta($current_user->ID,'iv_paypal_recurring_profile_id',true);
											...
											<?php
												...
												<div class="form-group">
															<label class="control-label"><?php  esc_html_e('Nothing to Cancel','tiger')	;?></label>
